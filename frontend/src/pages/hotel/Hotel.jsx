      ...
      <div className={openSlider ? "hotelContainerSlider" : "hotelContainer"}>
        {openSlider && (
          <div className="slider">
            ...
            />
            <FontAwesomeIcon icon={faCircleArrowLeft} className="arrow" onClick={() => handleChangeSlide("l")} />
            <div className="sliderWrapper">
              <img src={photos[slideIndex].src} alt="" className="sliderImg" />
            </div>
            <FontAwesomeIcon icon={faCircleArrowRight} className="arrow" onClick={() => handleChangeSlide("r")} />
          </div>
        )}
